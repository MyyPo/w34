...
func (x *NewProjectRequest) GetIsPublic() bool {
	if x != nil {
		return x.IsPublic
	}
	return false
...
type NewSceneRequest struct {
	...
	IngameId int32             `protobuf:"varint,3,opt,name=ingame_id,json=ingameId,proto3" json:"ingame_id,omitempty"`
...
func (x *NewSceneRequest) GetIngameId() int32 {
	if x != nil {
		return x.IngameId
	}
	return 0
...
type Scene struct {
	...
	IngameId int32  `protobuf:"varint,1,opt,name=ingame_id,json=ingameId,proto3" json:"ingame_id,omitempty"`
...
func (x *Scene) GetIngameId() int32 {
	if x != nil {
		return x.IngameId
	}
	return 0
...
func (x *GetProjectRequest) Reset() {
	*x = GetProjectRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_dev_v1_dev_proto_msgTypes[13]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetProjectRequest) Descriptor() ([]byte, []int) {
	return file_dev_v1_dev_proto_rawDescGZIP(), []int{13}
}
...
func (x *GetProjectResponse) Reset() {
	*x = GetProjectResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_dev_v1_dev_proto_msgTypes[14]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetProjectResponse) Descriptor() ([]byte, []int) {
	return file_dev_v1_dev_proto_rawDescGZIP(), []int{14}
}
...
type NewTagRequest struct {
	...
	Project  string `protobuf:"bytes,1,opt,name=project,proto3" json:"project,omitempty"`
	IngameId int32  `protobuf:"varint,2,opt,name=ingame_id,json=ingameId,proto3" json:"ingame_id,omitempty"`
	Name     string `protobuf:"bytes,3,opt,name=name,proto3" json:"name,omitempty"`
	Desc     string `protobuf:"bytes,4,opt,name=desc,proto3" json:"desc,omitempty"`
}

func (x *NewTagRequest) Reset() {
	*x = NewTagRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_dev_v1_dev_proto_msgTypes[15]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *NewTagRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*NewTagRequest) ProtoMessage() {}

func (x *NewTagRequest) ProtoReflect() protoreflect.Message {
	mi := &file_dev_v1_dev_proto_msgTypes[15]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use NewTagRequest.ProtoReflect.Descriptor instead.
func (*NewTagRequest) Descriptor() ([]byte, []int) {
	return file_dev_v1_dev_proto_rawDescGZIP(), []int{15}
}

func (x *NewTagRequest) GetProject() string {
	if x != nil {
		return x.Project
	}
	return ""
...
func (x *NewTagRequest) GetIngameId() int32 {
	if x != nil {
		return x.IngameId
	}
	return 0
...
func (x *NewTagRequest) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *NewTagRequest) GetDesc() string {
	if x != nil {
		return x.Desc
	}
	return ""
...
type NewTagResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *NewTagResponse) Reset() {
	*x = NewTagResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_dev_v1_dev_proto_msgTypes[16]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *NewTagResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*NewTagResponse) ProtoMessage() {}

func (x *NewTagResponse) ProtoReflect() protoreflect.Message {
	mi := &file_dev_v1_dev_proto_msgTypes[16]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use NewTagResponse.ProtoReflect.Descriptor instead.
func (*NewTagResponse) Descriptor() ([]byte, []int) {
	return file_dev_v1_dev_proto_rawDescGZIP(), []int{16}
}
...
var file_dev_v1_dev_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x12, 0x06, 0x64, 0x65, 0x76, 0x2e, 0x76, 0x31, 0x22, 0x44, 0x0a, 0x11, 0x4e, 0x65,
	...
	0x22, 0x14, 0x0a, 0x12, 0x4e, 0x65, 0x77, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x52, 0x65,
	...
	0x65, 0x63, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x5c, 0x0a, 0x12, 0x4e,
	0x65, 0x77, 0x4c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	...
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0x15, 0x0a, 0x13, 0x4e, 0x65, 0x77,
	0x4c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	0x22, 0xe0, 0x01, 0x0a, 0x0f, 0x4e, 0x65, 0x77, 0x53, 0x63, 0x65, 0x6e, 0x65, 0x52, 0x65, 0x71,
	...
	0x67, 0x61, 0x6d, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x08, 0x69,
	0x6e, 0x67, 0x61, 0x6d, 0x65, 0x49, 0x64, 0x12, 0x3e, 0x0a, 0x07, 0x6f, 0x70, 0x74, 0x69, 0x6f,
	0x6e, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x24, 0x2e, 0x64, 0x65, 0x76, 0x2e, 0x76,
	0x31, 0x2e, 0x4e, 0x65, 0x77, 0x53, 0x63, 0x65, 0x6e, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	...
	0x02, 0x38, 0x01, 0x22, 0x2d, 0x0a, 0x10, 0x4e, 0x65, 0x77, 0x53, 0x63, 0x65, 0x6e, 0x65, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x19, 0x0a, 0x08, 0x73, 0x63, 0x65, 0x6e, 0x65,
	0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x07, 0x73, 0x63, 0x65, 0x6e, 0x65,
	0x49, 0x64, 0x22, 0x65, 0x0a, 0x12, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x53, 0x63, 0x65, 0x6e,
	...
	0x0a, 0x08, 0x73, 0x63, 0x65, 0x6e, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05,
	0x52, 0x07, 0x73, 0x63, 0x65, 0x6e, 0x65, 0x49, 0x64, 0x22, 0x15, 0x0a, 0x13, 0x44, 0x65, 0x6c,
	0x65, 0x74, 0x65, 0x53, 0x63, 0x65, 0x6e, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	0x22, 0x50, 0x0a, 0x18, 0x47, 0x65, 0x74, 0x4c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x53,
	0x63, 0x65, 0x6e, 0x65, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x18, 0x0a, 0x07,
	...
	,
	...
	0x65, 0x63, 0x74, 0x22, 0x53, 0x0a, 0x12, 0x47, 0x65, 0x74, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63,
	...
	,
...
var file_dev_v1_dev_proto_msgTypes = make([]protoimpl.MessageInfo, 18)
var file_dev_v1_dev_proto_goTypes = []interface{}{
	...
	(*GetProjectRequest)(nil),         // 13: dev.v1.GetProjectRequest
	(*GetProjectResponse)(nil),        // 14: dev.v1.GetProjectResponse
	(*NewTagRequest)(nil),             // 15: dev.v1.NewTagRequest
	(*NewTagResponse)(nil),            // 16: dev.v1.NewTagResponse
	nil,                               // 17: dev.v1.NewSceneRequest.OptionsEntry
}
var file_dev_v1_dev_proto_depIdxs = []int32{
	17, // 0: dev.v1.NewSceneRequest.options:type_name -> dev.v1.NewSceneRequest.OptionsEntry
...
func file_dev_v1_dev_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_dev_v1_dev_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dev_v1_dev_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dev_v1_dev_proto_msgTypes[15].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*NewTagRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_dev_v1_dev_proto_msgTypes[16].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*NewTagResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
